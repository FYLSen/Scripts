...
!(async () => {
  ...
  for (let i = 0; i < cookiesArr.length; i++) {
    ...
    shareCode = ["T0225KkcRxga9AbWIhzykfJYcgCjRQmoaX5kRrbA","T0184qQtHEdH9FHRJBn3kQCjRQmoaX5kRrbA","T018v_h7Qxwd8lPTJByb1ACjRQmoaX5kRrbA","T0225KkcRh8epwXVdhnylaZcJQCjRQmoaX5kRrbA"]
